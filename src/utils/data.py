reactionroles_data = {
    "Study Ping Roles": {
        "Languages": [
            ["🇬🇧", "English Language", 941218859250225152],
            ["📖", "English/World Literature", 941504895700320266],
            ["2️⃣", "English as a Second Language", 941218932570869770],
            ["🇸🇦", "Arabic", 945568732393140224],
            ["🇮🇳", "Hindi", 942791804464541726],
            ["🇫🇷", "French", 942791457104855041],
            ["🇩🇪", "German", 945565232032542802],
            ["🇨🇳", "Mandarin", 945565876764155934],
            ["🇪🇸", "Spanish", 945568301860413501],
            ["🇵🇰", "Urdu", 945568902396661770],
            ["🇲🇾", "Malay", 945567198603280424],
        ],
        "Humanities and Social Sciences": [
            ["💸", "Economics", 944761951064567819],
    ...
    "Color Roles": {
        "Colors": [
            # ["Emoji", "Label", "Role ID (Value)", "if True, only 1k rep+ will see this"]
            ["🟡", "Yellow", 902191854974541825, False],
            ["🟢", "Green", 946251282962870324, False],
            ["🔵", "Blue", 946251561540153354, False],
            ["🟣", "Pink", 878507552143450142, False],
            ["🩷", "Hot Pink", 1216070412648190004, True],
            ["🩶", "Grey", 1216256441372119172, True],
            ["🩵", "Cyan", 1216073632401592470, True],
            ["🤎", "Maroon", 1216068095303618630, True],
            ["💙", "Sky Blue", 1216085788769386698, True],
            ["🟪", "Light Purple", 1216622647937339514, True],
            ["💜", "Purple", 946253578178273291, True],
            ["🔴", "Red", 903466559308177449, False],
            ["⚫", "Black", 904252997486395412, False],
            ["🟦", "Light Blue", 949665171931009104, False],
            ["🔷", "Dark Blue", 946696792349737000, False],
        ]
    },
}
