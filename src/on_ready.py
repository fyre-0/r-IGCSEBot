...
from constants import GUILD_ID, BOTLOG_CHANNEL_ID, BETA, CHAT_MODERATOR_ROLE, IGCSE_HELPER_ROLE, AL_HELPER_ROLE, BOT_DEVELOPER_ROLE, TEMP_MODERATOR_ROLE, STAFF_MODERATOR_ROLE
