...
from data import REP_DISABLE_CHANNELS, SUBJECT_CHANNELS, OFFTOPIC_CHANNELS
...
async def on_raw_typing(payload):
    if message.channel.id in SUBJECT_CHANNELS or message.channel.id in OFFTOPIC_CHANNELS or not payload.guild_id:
        return
