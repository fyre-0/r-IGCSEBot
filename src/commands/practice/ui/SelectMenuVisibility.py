...
class SelectMenuVisibility(discord.ui.View):
    def __init__(self, interaction: discord.Interaction):
        ...
        self.public = discord.ui.Button(
            label="Public", style=discord.ButtonStyle.primary
        )
        ...
        self.private = discord.ui.Button(
            label="Private", style=discord.ButtonStyle.primary
        )
