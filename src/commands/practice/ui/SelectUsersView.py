...
class SelectUsersView(discord.ui.View):
    def __init__(self, interaction: discord.Interaction):
        ...
        self.user_select = UserSelect(placeholder="Select users", max_values=25)

        self.continue_button = discord.ui.Button(
            label="Continue", style=discord.ButtonStyle.green
        )
        ...
        self.alone_button = discord.ui.Button(
            label="I'm good alone", style=discord.ButtonStyle.blurple
        )
